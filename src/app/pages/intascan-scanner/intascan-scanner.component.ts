...
@Component({
  selector: 'app-intascan-scanner',
  templateUrl: './intascan-scanner.component.html',
  styleUrl: './intascan-scanner.component.css',
  standalone: false
})
export class IntascanScannerComponent{
  @ViewChild('cameraViewContainer') cameraViewContainer?: ElementRef<HTMLDivElement>;
  resultText = "";
  componentDestroyedErrorMsg = "Koniec skanowania";
  ...
  async ngAfterViewInit(): Promise<void> {
    try {
      ...
      if (this.isDestroyed) {
        throw Error(this.componentDestroyedErrorMsg);
      ...
      if ((ex as Error)?.message === this.componentDestroyedErrorMsg) {
        console.log(this.componentDestroyedErrorMsg);
      } else {
